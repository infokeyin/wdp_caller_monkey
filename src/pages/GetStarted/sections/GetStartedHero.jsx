        ...
        {TIMELINE.map((item, i) => (
          ...
          >
            ...
            >
              ...
              {i < TIMELINE.length - 1 && (
                <div
                  style={{ width: 1.5, height: 28, background: `${item.color}40`, marginBlock: 2 }}
                />
              )}
            </div>
            {/* Content */}
...
/* ── Key stats ── */
const STATS = [
  { val: 'Dynamic Pricing', label: 'Economical to use' },
  { val: '15 days', label: 'Go-live guarantee' },
  { val: 'Pay as you go', label: 'No fixed commitment' },
];
        ...
        >
          ...
          <div style={{ flex: '1 1 320px', minWidth: 0 }}>
            <FadeIn>
              ...
              <h1 className="custom-h1 mb-5" style={{ maxWidth: 550 }}>
                Pick Where to Begin. Add More as You Grow.
              </h1>
            </FadeIn>
            <FadeIn delay={0.08}>
              <p className="custom-lead mb-8" style={{ maxWidth: 550 }}>
                Most businesses start with AI Voice Calling and expand. Pay as you go, No lock-in.
              </p>
            </FadeIn>
