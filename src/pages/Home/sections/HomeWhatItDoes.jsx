...
const CAPABILITIES = [
  {
    ...
    color: '#2DA744',
    bg: '#E8F7EC',
    desc: 'Calls leads in under 2 minutes',
  },
  {
    icon: 'BellRing',
  ...
  },
  {
    ...
    color: '#25D366',
    bg: '#E6FBF0',
    desc: 'Replies & follow-ups on WhatsApp',
  },
  {
    icon: 'Mail',
    ...
    color: '#F4A623',
    bg: '#FEF6E7',
    desc: 'Sends emails on call outcomes',
  },
  {
    icon: 'Database',
    label: 'CRM Logging',
  ...
  },
  {
    ...
    color: '#0891B2',
    bg: '#E0F7FA',
    desc: 'Real-time dashboards & reports',
  },
  {
    icon: 'Languages',
    label: '70+ Languages',
...
function PipelineFlow() {
  return (
    ...
    >
      ...
      {/* Step labels */}
      <text x="175" y="18" textAnchor="middle" fontSize="9" fill="#9E9E9E" fontFamily="system-ui">
        AI calls &amp; qualifies
      </text>
      <text x="465" y="18" textAnchor="middle" fontSize="9" fill="#9E9E9E" fontFamily="system-ui">
        CRM logged · follow-up sent
      </text>
    </svg>
  );
}
      ...
      <Container>
        ...
        <FadeIn>
          ...
          <p className="custom-lead mb-8" style={{ maxWidth: 520 }}>
            Every piece of business communication that currently needs manual effort — handled
            automatically, end to end.
          </p>
        </FadeIn>

        {/* Pipeline SVG */}
        <FadeIn delay={0.08}>{!reduced && <PipelineFlow />}</FadeIn>
