...
import { ArrowRight, Clock, PhoneCall, Users, TrendingUp } from 'lucide-react';
      ...
      <Container style={{ position: 'relative', zIndex: 1 }}>
        ...
        <FadeIn>
          <div style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
            ...
            >
              30 minutes. Your tools, your industry. We'll show you exactly how Caller Monkey
            ...
            {TRUST_ITEMS.map(({ Icon, stat, label }, i) => (
              <div
                ...
                style={{
                  ...
                  gap: '0.35rem',
                  borderRight:
                    i < TRUST_ITEMS.length - 1 ? '1px solid rgba(255,255,255,0.1)' : 'none',
                }}
              >
                <Icon
                  size={16}
